...
auskommt. Wir müssen uns jedoch wie auch bei Lloyds Algorithmus ohne die Kernel Methode mit der geeigneten initialen Wahl
...
\absatz
Wir erinnern uns, dass wir im Zusammenhang mit \kmpp{} für einen Punkt $x$ aus der Eingabe-Punktmenge $P$ wir mit $D(x)$
